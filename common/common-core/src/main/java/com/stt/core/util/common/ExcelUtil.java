...
import com.stt.core.util.classUtil.ReflectUtils;
...
import com.stt.core.annotation.Excel;
import com.stt.core.annotation.Excel.Type;
...
public class ExcelUtil<T> {
    ...
    public void init(List<T> list, String sheetName, Type type) {
        ...
        log.info("导出表名称:" + sheetName);
        log.info("导出表条目数:" + list.size());
        this.list = list;
    ...
    public Result exportExcel(List<T> list, String sheetName, HttpServletResponse response) throws IOException {
        log.info("=====================初始化excel表格=====================");
        this.init(list, sheetName, Type.EXPORT);
        log.info("=====================开始导出=====================");
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = System.getProperty("java.io.tmpdir") + File.separator + "download" + File.separator + filename;
        log.info("=====================获取下载路径:" + downloadPath + "=====================");
